...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url();?>assets/plugins/images/ikhlas.png">
    <title>BK | Login Admin</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="col-md-4 col-md-offset-4" style="margin-top:80px; ">
                    <div class="white-box" style="border-top:3px solid #9C27B0; box-shadow: 1px 0px 4px 1px #00000087;">
                        <div class="text-center">
                            <img src="<?php echo base_url();?>assets/ikhlas.png" style="width:150px;">
                        </div>
